	...
	return (
		<Fade triggerOnce direction="up" cascade damping={0.15}>
			<div className="container mx-auto px-4">
				...
				<div className="mx-auto mb-10 h-0.5 w-20 bg-[#c4a35a]" />
				...
				<div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-3">
					...
					<div className="card-hover rounded-lg bg-white p-8 text-center shadow-md transition-all duration-300 hover:shadow-lg">
						...
						<p className="text-gray-700">
							Você terá seu caso analisado por um advogado especialista que vai
							tirar todas suas dúvidas pelo WhatsApp — sem pagar nada por isso.
						</p>
					</div>
