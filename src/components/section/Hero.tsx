...
import Logo from "public/images/logoTransparent2.png";
...
export function HeroSection() {
	return (
		...
		>
			<div className="mb-5 ml-4 flex h-48 w-80 transform items-center justify-center rounded-md duration-300 hover:scale-105 lg:mb-0 lg:h-60">
				<div className="relative h-full w-full overflow-hidden rounded-md bg-[#0f1b2b]">
					...
					<div className="absolute inset-0 bg-[length:20px_20px] bg-[linear-gradient(45deg,_transparent_25%,_#c4a35a/5_25%,_#c4a35a/5_50%,_transparent_50%,_transparent_75%,_#c4a35a/5_75%)]" />
