...
export function HeroSection() {
	return (
		...
		>
			<div className="mb-5 ml-4 w-fit transform rounded-md bg-[#C4A35A] p-4 uppercase transition-transform duration-300 hover:scale-105 lg:p-6">
				<h1 className="font-bold text-sm text-white lg:text-2xl">
					Machado Advogados
				</h1>
			</div>
