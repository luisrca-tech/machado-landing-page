	...
	return (
		<Fade triggerOnce direction="up" cascade damping={0.15}>
			<div className="container mx-auto px-4">
				...
				<div className="mx-auto mb-10 h-1.5 w-20 bg-white" />

				<p className="mb-8 text-center font-bold text-lg text-white">
					Descobrir se sua situação pode ser avaliada por um advogado{" "}
					<span className="text-[#c4a35a]">é bem simples</span> <br /> caso você{" "}
					<span className="text-[#c4a35a]">desconfie</span> que tem algo de
